...
src/
  app/                 uma pasta por rota (App Router)
    ...
    exclusivoparavoce/            ← campanha pós-evento, só por QR Code (ver docs/exclusivoparavoce.md)
...
- [`docs/identidade-visual.md`](docs/identidade-visual.md) — paleta, tipografia e as
  marcas em SVG.
- [`docs/exclusivoparavoce.md`](docs/exclusivoparavoce.md) — a página de campanha pós-evento.
- [`docs/verificacao-idade.md`](docs/verificacao-idade.md) — o pop-up de maioridade.
