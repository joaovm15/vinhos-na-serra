...
export const wines: Wine[] = [
  {
    ...
    vintage: "2021",
    description:
      "Vinificado nas encostas mais altas da vinícola parceira, este tinto passa 14 meses em barril de carvalho francês, resultando em um vinho de corpo firme e taninos macios.",
  ...
  },
  {
    ...
    type: "Branco",
    grape: "Chardonnay",
    region: "São Joaquim, SC",
    vintage: "2023",
    description:
      "Uvas colhidas a mais de 900m de altitude, garantindo acidez vibrante e frescor mineral característicos do terroir de altitude catarinense.",
  ...
  },
  {
    ...
    vintage: "2023",
    description:
      "Um rosé delicado, feito por sangria, que carrega a leveza e o frescor das manhãs frias da serra gaúcha.",
  ...
  },
  {
    ...
    region: "Vale do São Francisco, PE",
    vintage: "2020",
    description:
